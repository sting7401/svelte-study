...
<div class="slog-content-box">
	<div class="content-box-header">
		...
		<div class="content-box-header-inner-right">
			...
			<div class="drop-menu-box">
				<ul>
					<li><a href="#" class="drop-menu-button">수정</a></li>
					<li><a href="#" class="drop-menu-button">삭제</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="content-box-main">
		<p class="whitespace-pre-line">
			...
			laboris labore nisi amet do dolor eu fugiat consectetur elit cillum esse. Pariatur
			occaecat nisi laboris tempor laboris eiusmod qui id Lorem esse commodo in. Exercitation
			aute dolore deserunt culpa consequat elit labore incididunt elit anim.
		</p>
	</div>
