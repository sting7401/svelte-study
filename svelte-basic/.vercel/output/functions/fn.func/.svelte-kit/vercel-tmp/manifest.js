export const manifest = {
	...
	_: {
		client: {"start":"_app/immutable/entry/start.c4a6f0a4.js","app":"_app/immutable/entry/app.c5168af1.js","imports":["_app/immutable/entry/start.c4a6f0a4.js","_app/immutable/chunks/index.10dfffe8.js","_app/immutable/chunks/singletons.99188a43.js","_app/immutable/chunks/index.b2a7721a.js","_app/immutable/chunks/parse.d12b0d5b.js","_app/immutable/entry/app.c5168af1.js","_app/immutable/chunks/index.10dfffe8.js"],"stylesheets":[],"fonts":[]},
		nodes: [
		...
		routes: [
			...
			{
				id: "/api/json-list",
				pattern: /^\/api\/json-list\/?$/,
				params: [],
				page: null,
				endpoint: () => import('../output/server/entries/endpoints/api/json-list/_server.js')
			},
			{
				id: "/api/postcodes",
			...
			},
			{
				...
				page: { layouts: [0,7,8,9,], errors: [1,,,10,], leaf: 39 },
				endpoint: null
			},
			{
				...
				page: { layouts: [0,7,], errors: [1,,], leaf: 40 },
				endpoint: null
			},
			{
				id: "/(form)/news",
			...
			},
			{
				...
				pattern: /^\/products\/?$/,
				params: [],
				page: { layouts: [0,7,], errors: [1,,], leaf: 41 },
				endpoint: null
			},
			{
			...
			},
			{
				...
				pattern: /^\/stock\/?$/,
				params: [],
				page: { layouts: [0,7,11,], errors: [1,,,], leaf: 44 },
				endpoint: null
			},
			{
				id: "/(app)/test02",
